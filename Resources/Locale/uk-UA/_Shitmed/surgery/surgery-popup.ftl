...
surgery-step-acid-popup = Кислотна кров бризкає з {$part} {$target}!
surgery-popup-step-SurgeryStepXenoCutExoskeleton = {$user} надрізає екзоскелет {$part} {$target}.
surgery-popup-step-SurgeryStepXenoClampBleeders = {$user} затискає кислотні судини {$part} {$target}.
surgery-popup-step-SurgeryStepXenoSeverPlasma = {$user} перерізає плазмові з'єднання {$part} {$target}.
surgery-popup-step-SurgeryStepXenoRetractExoskeleton = {$user} відводить екзоскелет {$part} {$target}.
surgery-popup-step-SurgeryStepXenoSawExoskeleton = {$user} пиляє крізь екзоскелет {$part} {$target}.
surgery-popup-step-SurgeryStepXenoMendExoskeleton = {$user} з'єднує екзоскелет {$part} {$target}.
surgery-popup-step-SurgeryStepXenoCloseExoskeleton = {$user} закриває екзоскелет {$part} {$target}.
surgery-popup-step-SurgeryStepXenoRetractEndoskeleton = {$user} відводить ендоскелет {$part} {$target}.
surgery-popup-step-SurgeryStepXenoSawEndoskeleton = {$user} пиляє крізь ендоскелет {$part} {$target}.
surgery-popup-step-SurgeryStepXenoMendEndoskeleton = {$user} з'єднує ендоскелет {$part} {$target}.
surgery-popup-step-SurgeryStepXenoCloseEndoskeleton = {$user} закриває ендоскелет {$part} {$target}.
surgery-popup-step-SurgeryStepXenoCloseIncision = {$user} закриває розріз на {$part} {$target}.
surgery-popup-step-SurgeryStepXenoSealOrganWound = {$user} зашиває рани на {$part} {$target}.
surgery-popup-step-SurgeryStepXenoNeutralizeAcid = {$user} нейтралізує кислоту на {$part} {$target}.
surgery-popup-step-SurgeryStepXenoRemoveFeature = {$user} ампутує {$part} {$target}!
surgery-popup-step-SurgeryStepXenoRemoveOrgan = {$user} видаляє орган з {$part} {$target}!
surgery-popup-step-SurgeryStepInsertHiveNode = {$user} вставляє вузол вулика в {$part} {$target}!
surgery-popup-step-SurgeryStepInsertResinSpinner = {$user} вставляє прядильник смоли в {$part} {$target}!
surgery-popup-step-SurgeryStepInsertNeurotoxinGland = {$user} вставляє залозу нейротоксину в {$part} {$target}!
surgery-popup-step-SurgeryStepInsertAcidGland = {$user} вставляє кислотну залозу в {$part} {$target}!
surgery-popup-step-SurgeryStepInsertPlasmaVessel = {$user} вставляє плазмову судину в {$part} {$target}!
