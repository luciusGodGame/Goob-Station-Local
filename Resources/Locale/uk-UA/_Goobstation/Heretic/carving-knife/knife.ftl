...
carving-knife-comp-cant-draw = Тут не можна малювати різьблення!
carving-knife-comp-too-many-runes = Забагато різьблень!
carving-knife-comp-close-to-another-carving = Занадто близько до іншого різьблення!
...
alert-carving-trigger-message = "{$victim}" ступив на руну сповіщення біля "{$location}"!
