...
atmos-monitoring-window-toggle-overlays = Перемикати накладання мап
atmos-monitoring-window-show-pipe-network = Трубна мережа
atmos-monitoring-window-show-gas-pipe-sensors = Датчики газових труб
atmos-monitoring-window-label-gases = Присутні гази
atmos-monitoring-window-flavor-left = Зверніться за допомогою до фахівця з атмосферних систем
