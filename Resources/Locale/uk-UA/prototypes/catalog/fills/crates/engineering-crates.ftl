...
ent-CrateRCDAmmo = Ящик з боєприпасами для УЗК
    .desc = 3 боєприпаси для УЗК, кожен з яких відновлює 5 зарядів.

ent-CrateRCD = Ящик з універсальним засобою конструювання
    .desc = Ящик, що містить один пристрій швидкого будівництва (УЗК).
